...
WebUI.takeFullPageScreenshotAsCheckpoint('Appointment_Validation')

WebUI.click(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/input_Apply for hospital readmission_hospit_63901f'))

WebUI.click(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/span_Visit Date (Required)_glyphicon glyphi_cada34'))

WebUI.click(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/td_30'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('Appointment_Confirmation')

WebUI.click(findTestObject('Object Repository/Visual Testing/Page_CURA Healthcare Service/h2_Appointment Confirmation'))
